...
**Step 2.6:** Get the Hyperledger Composer sample applications from GitHub::
 ...
 remote: Total 2041 (delta 51), reused 40 (delta 22), pack-reused 1963
 Receiving objects: 100% (2041/2041), 34.89 MiB | 56.62 MiB/s, done.
...
**Step 2.14:** Use *git* to get the GitHub repository that contains these convenient scripts::
 ...
 remote: Total 1421 (delta 24), reused 33 (delta 18), pack-reused 1360
 Receiving objects: 100% (1421/1421), 8.41 MiB | 12.91 MiB/s, done.
...
**Step 4.36:** Now run the *composer network upgrade* command.  If your version differs from *0.2.3-deploy.2* use the value shown on your system in place of *0.2.6-deploy.2* in the command::
